...
You can access the SimpleSAMLphp web interface of the IdP under `http://localhost:8082/simplesaml`. The admin password is `secret`.
...
- The local development URL of the IdP is `http://localhost:8082`.
...
```
    'test-sp' => array(
        ...
        'idp' => 'http://localhost:8082/simplesaml/saml2/idp/metadata.php',
    ),
```

Add the following entry to the `metadata/saml20-idp-remote.php` file of SimpleSAMLphp.
```
$metadata['http://localhost:8082/simplesaml/saml2/idp/metadata.php'] = array(
    'name' => array(
        'en' => 'Test IdP',
    ),
    'description' => 'Test IdP',
    'SingleSignOnService' => 'http://localhost:8082/simplesaml/saml2/idp/SSOService.php',
    'SingleLogoutService' => 'http://localhost:8082/simplesaml/saml2/idp/SingleLogoutService.php',
